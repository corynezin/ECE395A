    ...
    \begin{enumerate}
      ...
      \begin{enumerate}
        \item Design high level architecture to increase data reuse and reduce energy consumption. Some examples of high level architectures include:
          \begin{enumerate}
              \item Weight stationary (WS) \citet{DBLP:journals/corr/SzeCYE17}
              \item Output stationary (OS) \citet{DBLP:journals/corr/SzeCYE17}
              \item Row stationary (RS) \citet{DBLP:journals/corr/SzeCYE17}
          \end{enumerate}
