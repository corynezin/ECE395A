...
HD_PWD='/home/nezin/Documents/ECE395A/vhdl/argmax/argmax.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log argmax_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source argmax_tb.tcl -notrace
