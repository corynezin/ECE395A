...
HD_PWD='/home/nezin/Documents/ECE395A/vhdl/argmax/argmax.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log argmax_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source argmax_tb.tcl
