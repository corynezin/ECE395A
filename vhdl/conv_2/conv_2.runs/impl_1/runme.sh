...
HD_PWD='/home/nezin/Documents/ECE395A/vhdl/conv_2/conv_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log conv_2_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source conv_2_tb.tcl -notrace
