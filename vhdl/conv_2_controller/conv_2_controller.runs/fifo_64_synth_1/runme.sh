...
HD_PWD='/home/nezin/Documents/ECE395A/vhdl/conv_2_controller/conv_2_controller.runs/fifo_64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_64.tcl
