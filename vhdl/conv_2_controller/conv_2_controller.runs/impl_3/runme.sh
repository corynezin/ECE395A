...
HD_PWD='/home/nezin/Documents/ECE395A/vhdl/conv_2_controller/conv_2_controller.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log conv2_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source conv2_controller.tcl -notrace
