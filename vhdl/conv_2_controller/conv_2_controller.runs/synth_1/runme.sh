...
HD_PWD='/home/nezin/Documents/ECE395A/vhdl/conv_2_controller/conv_2_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log conv2_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source conv2_controller.tcl
