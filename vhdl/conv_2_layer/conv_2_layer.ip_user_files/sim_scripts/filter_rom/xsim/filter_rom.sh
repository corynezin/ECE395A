...
#
# Generated by Vivado on Sun Dec 10 22:37:34 EST 2017
# IP Build 1909766 on Thu Jun 15 19:58:00 MDT 2017 
#
# usage: filter_rom.sh [-help]
...
# Script info
echo -e "filter_rom.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot filter_rom xil_defaultlib.filter_rom -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim filter_rom -key {Behavioral:sim_1:Functional:filter_rom} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb filter_rom.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./filter_rom.sh -help\" for more information)\n"
    exit 1
  fi
