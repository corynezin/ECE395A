...
HD_PWD='/home/nezin/Documents/ECE395A/vhdl/conv_2_layer/conv_2_layer.runs/fifo_16x24_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_16x24.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_16x24.tcl
