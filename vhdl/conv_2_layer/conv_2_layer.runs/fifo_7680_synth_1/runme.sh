...
HD_PWD='/home/nezin/Documents/ECE395A/vhdl/conv_2_layer/conv_2_layer.runs/fifo_7680_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_7680.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_7680.tcl
