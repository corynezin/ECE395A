...
set rc [catch {
  ...
  add_files -quiet /home/nezin/Documents/ECE395A/vhdl/conv_2_layer/conv_2_layer.runs/synth_1/conv_layer_2_tb.dcp
  ...
  link_design -top conv_layer_2_tb -part xc7z020clg484-1
...
set rc [catch {
  ...
  opt_design 
  write_checkpoint -force conv_layer_2_tb_opt.dcp
  catch { report_drc -file conv_layer_2_tb_drc_opted.rpt }
...
set rc [catch {
  ...
  place_design 
  write_checkpoint -force conv_layer_2_tb_placed.dcp
  catch { report_io -file conv_layer_2_tb_io_placed.rpt }
  catch { report_utilization -file conv_layer_2_tb_utilization_placed.rpt -pb conv_layer_2_tb_utilization_placed.pb }
  catch { report_control_sets -verbose -file conv_layer_2_tb_control_sets_placed.rpt }
...
set rc [catch {
  ...
  route_design 
  write_checkpoint -force conv_layer_2_tb_routed.dcp
  catch { report_drc -file conv_layer_2_tb_drc_routed.rpt -pb conv_layer_2_tb_drc_routed.pb -rpx conv_layer_2_tb_drc_routed.rpx }
  catch { report_methodology -file conv_layer_2_tb_methodology_drc_routed.rpt -rpx conv_layer_2_tb_methodology_drc_routed.rpx }
  catch { report_power -file conv_layer_2_tb_power_routed.rpt -pb conv_layer_2_tb_power_summary_routed.pb -rpx conv_layer_2_tb_power_routed.rpx }
  catch { report_route_status -file conv_layer_2_tb_route_status.rpt -pb conv_layer_2_tb_route_status.pb }
  catch { report_clock_utilization -file conv_layer_2_tb_clock_utilization_routed.rpt }
  catch { report_timing_summary -warn_on_violation -max_paths 10 -file conv_layer_2_tb_timing_summary_routed.rpt -rpx conv_layer_2_tb_timing_summary_routed.rpx }
  close_msg_db -file route_design.pb
} RESULT]
if {$rc} {
  write_checkpoint -force conv_layer_2_tb_routed_error.dcp
