...
HD_PWD='/home/nezin/Documents/ECE395A/vhdl/conv_relu_pool/conv_relu_pool.runs/fir128_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fir128_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fir128_0.tcl
