...
HD_PWD='/home/nezin/Documents/ECE395A/vhdl/inner_product_fifo/inner_product_fifo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dot.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dot.tcl -notrace
