...
HD_PWD='/home/nezin/Documents/ECE395A/vhdl/inner_product_fifo/inner_product_fifo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dot.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dot.tcl
