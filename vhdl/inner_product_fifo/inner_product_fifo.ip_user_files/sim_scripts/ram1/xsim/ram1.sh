...
#
# Generated by Vivado on Wed Oct 18 20:43:47 EDT 2017
...
# Script info
echo -e "ram1.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot ram1 xil_defaultlib.ram1 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim ram1 -key {Behavioral:sim_1:Functional:ram1} -tclbatch cmd.tcl -log simulate.log
}
