...
#
# Generated by Vivado on Wed Oct 18 21:12:53 EDT 2017
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot ram2 xil_defaultlib.ram2 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim ram2 -key {Behavioral:sim_1:Functional:ram2} -tclbatch cmd.tcl -log simulate.log
}
