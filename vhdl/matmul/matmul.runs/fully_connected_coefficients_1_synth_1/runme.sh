...
HD_PWD='/home/nezin/Documents/ECE395A/vhdl/matmul/matmul.runs/fully_connected_coefficients_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fully_connected_coefficients_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fully_connected_coefficients_1.tcl
