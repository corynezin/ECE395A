...
HD_PWD='/home/bcv/Documents/ECE395A/vhdl/maxpool/maxpool.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log maxpool2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source maxpool2.tcl -notrace
