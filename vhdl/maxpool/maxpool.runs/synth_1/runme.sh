...
HD_PWD='/home/bcv/Documents/ECE395A/vhdl/maxpool/maxpool.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log maxpool2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source maxpool2.tcl
