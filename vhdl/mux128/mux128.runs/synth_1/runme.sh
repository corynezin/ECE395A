...
HD_PWD='/home/bcv/Documents/ECE395A/vhdl/mux128/mux128.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux128.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux128.tcl
