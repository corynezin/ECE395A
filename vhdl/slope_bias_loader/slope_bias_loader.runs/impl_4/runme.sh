...
HD_PWD='/home/nezin/Documents/ECE395A/vhdl/slope_bias_loader/slope_bias_loader.runs/impl_4'
cd "$HD_PWD"
...
EAStep vivado -log slope_bias_loader_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source slope_bias_loader_tb.tcl -notrace
