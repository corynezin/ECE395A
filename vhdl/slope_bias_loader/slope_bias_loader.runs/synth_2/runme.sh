...
HD_PWD='/home/nezin/Documents/ECE395A/vhdl/slope_bias_loader/slope_bias_loader.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log slope_bias_loader_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source slope_bias_loader_tb.tcl
