...
#
# Generated by export_simulation on Tue Oct 24 14:55:35 EDT 2017
#
################################################################################
...
switch to the './dot_tb.sh' script.
...
./dot_tb.sh -noclean_files

For more information on the script, please type './dot_tb.sh -help'.
