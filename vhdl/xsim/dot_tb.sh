...
#
# Generated by Vivado on Tue Oct 24 14:55:35 EDT 2017
# IP Build 1909766 on Thu Jun 15 19:58:00 MDT 2017 
#
# usage: dot_tb.sh [-help]
# usage: dot_tb.sh [-lib_map_path]
# usage: dot_tb.sh [-noclean_files]
# usage: dot_tb.sh [-reset_run]
#
# ********************************************************************************************************
...
# Script info
echo -e "dot_tb.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_7 -L xbip_pipe_v3_0_3 -L xbip_bram18k_v3_0_3 -L mult_gen_v12_0_12 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_dsp48_addsub_v3_0_3 -L xbip_dsp48_multadd_v3_0_3 -L xbip_multadd_v3_0_10 -L xil_defaultlib -L secureip -L xpm --snapshot dot_tb xil_defaultlib.dot_tb -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim dot_tb -key {Behavioral:sim_1:Functional:dot_tb} -tclbatch cmd.tcl -log simulate.log
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./dot_tb.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dot_tb.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./dot_tb.sh -help\" for more information)\n"
    exit 1
  fi
